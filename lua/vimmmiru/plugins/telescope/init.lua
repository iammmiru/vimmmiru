return {
  {
    ...
    keys = function()
      ...
      vim.keymap.set(
        "n",
        "<leader>sg",
        require("vimmmiru.plugins.telescope.multigrep").live_multigrep,
      ...
      vim.keymap.set("n", "<leader>gs", require("telescope.builtin").git_status, { desc = "Telescope: [G]it [S]tatus" })
      vim.keymap.set("n", "<leader>sk", require("telescope.builtin").keymaps, { desc = "Telescope: [S]how [K]eymaps" })
    end,
    opts = {
      extensions = {
        fzf = {},
